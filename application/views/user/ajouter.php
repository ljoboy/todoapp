...
<head>
    ...
    <title>TODOAPP | Enregistrement</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url('auth/ajouter'); ?>"><b>TODO</b>APP</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Enregistrez-vous en remplissant ce formulaire</p>

            <form action="<?= site_url('auth/ajouter') ?>" method="post">
                ...
                <div class="form-group has-feedback">
                    <input name="mdp2" type="password" class="form-control" placeholder="Retaper le mot de passe">
            ...
            <div class="social-auth-links text-center">
                <p>- OU -</p>
                <a href="<?= site_url('auth/index'); ?>" class="btn btn-block btn-social btn-facebook btn-flat"><i
                        class="fa fa-user"></i>
